module.exports = {
    ...
    execute(client, message) {
        if (!message.member.voice.channel) return message.channel.send(`${client.emotes.error} - Abe yaar jab pata hai ki music bot hai to voice channel join karna !`);
        ...
        message.channel.send({
            embed: {
                ...
                timestamp: new Date(),
                description: `saare filters ki list enable disable dono hai.\nSong me filter lagane ke liye \`${client.config.discord.prefix}filter\` use karo.`,
            },
        });
    },
};